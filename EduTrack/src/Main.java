...
public class Main {
    public static void main(String[] args) throws InvalidLoginException, CourseFullException, DropDeadlinePassedException {
        //Initialisation
        Administrator admin = new Administrator("admin@gmail.com", "admin123", "A1");
        ...
        studentList.add(new Student("aditya@gmail.com", "aditya", "Aditya Mehra", 1));
        studentList.add(new Student("anya@gmail.com", "anya", "Anya Goyal", 1));
        TeachingAssistant riri = new TeachingAssistant("ashij07@gmail.com", "ashi", "Ashi Jain", 1);
        teachingAssistantList.add(riri);
        studentList.add(riri);
        professorList.add(new Professor("prof1@gmail.com", "pass123", "P1", "3-4:30 PM Mon/Thurs"));
        professorList.add(new Professor("prof2@gmail.com", "pass123", "P2", "1-3PM Wed/Tues"));
        professorList.add(new Professor("prof3@gmail.com", "pass123", "P3", "2-3 PM Fri/Sat/Mon"));
    ...
    private static void submitFeedback(Scanner scanner, Student student, List<Course> courseList) {
        ...
        /*if (course != null) {
            ...
            String feedbackContent = scanner.nextLine(); // Get feedback content from user
            Feedback<String> feedback = new Feedback<>(feedbackContent); // Create a Feedback instance
            student.submitFeedback(course, feedback); // Submit feedback
        } else {
            System.out.println("Course not found.");
        }*/
    }
